...
mount $partition /mnt
pacstrap /mnt base base-devel linux linux-firmware sudo nvim git
...
pacman -S --noconfirm xorg-server xorg-xinit xorg-xkill xorg-xsetroot xorg-xprop \
     ...
     dhcpcd networkmanager rsync pamixer xf86-video-amdgpu lohit-fonts \
     ttf-inconsolata ttf-roboto ttf-roboto-slab ttf-dejavu redshift clipmenu \
     ncdu pulseaudio pulseaudio-alsa
