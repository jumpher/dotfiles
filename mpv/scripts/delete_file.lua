...
mp.add_key_binding("alt+c", "delete_file", mark_delete)
mp.add_key_binding("alt+shift+c", "list_marks", list_marks)
mp.add_key_binding("ctrl+shift+alt+c", "clear_list", function() mp.osd_message("Undelete all"); del_list = {}; end)
